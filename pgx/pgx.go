...
func (t *TxQueryer) Exec(ctx context.Context, sql string, args ...interface{}) (insertId, affected int64, err error) {
...
func (t *TxQueryer) ExecRow(ctx context.Context, sql string, args ...interface{}) (insertId int64, err error) {
...
func (d *PgQueryer) Exec(ctx context.Context, sql string, args ...interface{}) (insertId, affected int64, err error) {
...
func (d *PgQueryer) ExecRow(ctx context.Context, sql string, args ...interface{}) (insertId int64, err error) {
	insertId, affected, err := d.Exec(ctx, sql, args...)
	if err == nil && affected < 1 {
		err = pgx.ErrNoRows
	}
	return
